...
|                   base-passwd |                         3.5.47 |
|                          bash |                 5.0-6ubuntu1.2 |
|                bind9-dnsutils |           1:9.16.1-0ubuntu2.14 |
|                    bind9-host |           1:9.16.1-0ubuntu2.14 |
|              bind9-libs:amd64 |           1:9.16.1-0ubuntu2.14 |
...
|         libmagick++-6-headers | 8:6.9.10.23+dfsg-2.1ubuntu11.7 |
|     libmagick++-6.q16-8:amd64 | 8:6.9.10.23+dfsg-2.1ubuntu11.7 |
|   libmagick++-6.q16-dev:amd64 | 8:6.9.10.23+dfsg-2.1ubuntu11.7 |
|               libmagick++-dev | 8:6.9.10.23+dfsg-2.1ubuntu11.7 |
...
|                     libpq-dev |             15.3-1.pgdg18.04+1 |
|                  libpq5:amd64 |             15.3-1.pgdg18.04+1 |
...
|              libxpm-dev:amd64 |      1:3.5.12-1ubuntu0.20.04.1 |
...
|          linux-libc-dev:amd64 |                  5.4.0-150.167 |
|                      llvm-6.0 |                     1:6.0.1-14 |
...
|          postgresql-client-12 |            12.15-1.pgdg18.04+1 |
|      postgresql-client-common |                250.pgdg18.04+1 |
|             postgresql-common |                250.pgdg18.04+1 |
|      postgresql-server-dev-12 |            12.15-1.pgdg18.04+1 |
...
|             python3-pil:amd64 |               7.0.0-4ubuntu0.7 |
...
|             ruby2.7-dev:amd64 |              2.7.0-5ubuntu1.11 |
