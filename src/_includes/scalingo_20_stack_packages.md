...
|                   base-passwd |                         3.5.47 |
|                          bash |                 5.0-6ubuntu1.2 |
|                bind9-dnsutils |     1:9.18.28-0ubuntu0.20.04.1 |
...
|     libmagick++-6.q16-8:amd64 | 8:6.9.10.23+dfsg-2.1ubuntu11.10 |
|   libmagick++-6.q16-dev:amd64 | 8:6.9.10.23+dfsg-2.1ubuntu11.10 |
...
|                     libpq-dev |             17.0-1.pgdg20.04+1 |
|                  libpq5:amd64 |             17.0-1.pgdg20.04+1 |
...
|              libruby2.7:amd64 |              2.7.0-5ubuntu1.14 |
...
|              libvpx-dev:amd64 |               1.8.2-1ubuntu0.3 |
...
|          postgresql-client-12 |            12.20-1.pgdg20.04+1 |
|      postgresql-client-common |                264.pgdg20.04+1 |
|             postgresql-common |                264.pgdg20.04+1 |
|      postgresql-server-dev-12 |            12.20-1.pgdg20.04+1 |
...
|             ruby2.7-dev:amd64 |              2.7.0-5ubuntu1.14 |
|                   ruby2.7-doc |              2.7.0-5ubuntu1.14 |
