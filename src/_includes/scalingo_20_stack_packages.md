...
|     libmagick++-6.q16-8:amd64 | 8:6.9.10.23+dfsg-2.1ubuntu11.9 |
|   libmagick++-6.q16-dev:amd64 | 8:6.9.10.23+dfsg-2.1ubuntu11.9 |
...
|            libmysqlclient-dev |        8.0.37-0ubuntu0.20.04.3 |
|        libmysqlclient21:amd64 |        8.0.37-0ubuntu0.20.04.3 |
...
|                     libpq-dev |             16.3-1.pgdg20.04+1 |
|                  libpq5:amd64 |             16.3-1.pgdg20.04+1 |
...
|          linux-libc-dev:amd64 |                  5.4.0-186.206 |
...
|          postgresql-client-12 |            12.19-1.pgdg20.04+1 |
|      postgresql-client-common |                260.pgdg20.04+1 |
|             postgresql-common |                260.pgdg20.04+1 |
|      postgresql-server-dev-12 |            12.19-1.pgdg20.04+1 |
