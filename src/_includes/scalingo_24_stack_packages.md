...
|                    bind9-host |     1:9.18.39-0ubuntu0.24.04.6 |
|              bind9-libs:amd64 |     1:9.18.39-0ubuntu0.24.04.6 |
...
|    libcurl4-openssl-dev:amd64 |             8.5.0-2ubuntu10.12 |
...
|                   libexif-doc |        0.6.24-1ubuntu0.24.04.1 |
...
|             libheif-dev:amd64 |              1.17.6-1ubuntu4.7 |
|   libheif-plugin-aomdec:amd64 |              1.17.6-1ubuntu4.7 |
|   libheif-plugin-aomenc:amd64 |              1.17.6-1ubuntu4.7 |
|                libheif1:amd64 |              1.17.6-1ubuntu4.7 |
...
|              libidn-dev:amd64 |                1.42-1ubuntu0.1 |
|                libidn12:amd64 |                1.42-1ubuntu0.1 |
...
|            libjbig2dec0:amd64 |          0.20-1ubuntu0.24.04.1 |
...
|              libruby3.2:amd64 |         3.2.3-1ubuntu0.24.04.8 |
...
|              libvpx-dev:amd64 |              1.14.0-1ubuntu2.3 |
...
|              libxpm-dev:amd64 |      1:3.5.17-1ubuntu0.24.04.1 |
...
|      postgresql-server-dev-16 |            16.15-1.pgdg24.04+2 |
...
|              python3-eventlet |              0.35.2-0ubuntu1.1 |
...
|             ruby3.2-dev:amd64 |         3.2.3-1ubuntu0.24.04.8 |
|                   ruby3.2-doc |         3.2.3-1ubuntu0.24.04.8 |
...
|                    vim-common |         2:9.1.0016-1ubuntu7.19 |
|                   vim-runtime |         2:9.1.0016-1ubuntu7.19 |
