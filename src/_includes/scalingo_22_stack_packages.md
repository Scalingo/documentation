...
|                          bash |                 5.1-6ubuntu1.1 |
|                bind9-dnsutils |     1:9.18.39-0ubuntu0.22.04.5 |
...
|                inetutils-ping |               2:2.2-2ubuntu0.2 |
...
|    libcurl4-openssl-dev:amd64 |             7.81.0-1ubuntu1.26 |
...
|                   libexif-doc |        0.6.24-1ubuntu0.22.04.1 |
...
|              libidn-dev:amd64 |                1.38-4ubuntu1.1 |
...
|             libncurses5:amd64 |                 6.3-2ubuntu0.2 |
...
|              libruby3.0:amd64 |              3.0.2-7ubuntu2.13 |
...
|               libtinfo5:amd64 |                 6.3-2ubuntu0.2 |
...
|              libvpx-dev:amd64 |              1.11.0-2ubuntu2.5 |
...
|              libxpm-dev:amd64 |      1:3.5.12-1ubuntu0.22.04.3 |
...
|          postgresql-client-14 |            14.24-1.pgdg22.04+2 |
|      postgresql-client-common |                293.pgdg22.04+1 |
|             postgresql-common |                293.pgdg22.04+1 |
|      postgresql-server-dev-14 |            14.24-1.pgdg22.04+2 |
...
|             ruby3.0-dev:amd64 |              3.0.2-7ubuntu2.13 |
|                   ruby3.0-doc |              3.0.2-7ubuntu2.13 |
...
|                           vim |         2:8.2.3995-1ubuntu2.35 |
|                    vim-common |         2:8.2.3995-1ubuntu2.35 |
|                   vim-runtime |         2:8.2.3995-1ubuntu2.35 |
