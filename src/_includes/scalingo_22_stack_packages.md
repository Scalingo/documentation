...
|              bind9-libs:amd64 |     1:9.18.12-0ubuntu0.22.04.3 |
...
|              libidn-dev:amd64 |                  1.38-4ubuntu1 |
...
|          libobjc-11-dev:amd64 |          11.4.0-1ubuntu1~22.04 |
|                libobjc4:amd64 |          12.3.0-1ubuntu1~22.04 |
...
|                  libpq5:amd64 |             16.0-1.pgdg22.04+1 |
...
|              libruby3.0:amd64 |               3.0.2-7ubuntu2.4 |
...
|                   llvm-14-dev |            1:14.0.0-1ubuntu1.1 |
|          llvm-14-linker-tools |            1:14.0.0-1ubuntu1.1 |
|               llvm-14-runtime |            1:14.0.0-1ubuntu1.1 |
...
|          postgresql-client-14 |             14.9-1.pgdg22.04+1 |
|      postgresql-client-common |                255.pgdg22.04+1 |
|             postgresql-common |                255.pgdg22.04+1 |
|      postgresql-server-dev-14 |             14.9-1.pgdg22.04+1 |
...
|                   python3-gpg |            1.16.0-1.2ubuntu4.1 |
...
|             ruby3.0-dev:amd64 |               3.0.2-7ubuntu2.4 |
