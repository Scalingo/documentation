This tutorial is validated by Scalingo and is provided as trusted guidance for
the documented use case.

It shows one possible way to use Scalingo, but it is not part of the Scalingo
product or managed service scope. Scalingo provides limited support for the
