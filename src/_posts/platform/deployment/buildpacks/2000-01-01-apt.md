---
title: APT Buildpack
description: "Use the APT buildpack to install additional Ubuntu packages during Scalingo builds, configure Aptfile dependencies, and validate package installation in build logs."
