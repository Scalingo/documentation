...
description: "Enable jemalloc on Scalingo with a multi-buildpack setup, configure allocator behavior through environment variables, and choose the appropriate jemalloc version."
