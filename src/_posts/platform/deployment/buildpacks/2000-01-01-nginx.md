...
description: "Configure the Nginx buildpack on Scalingo to run a custom reverse proxy or API gateway, provide nginx.conf rules, and inspect output for validation."
nav: Nginx Buildpack
