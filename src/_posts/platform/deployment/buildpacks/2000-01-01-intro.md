---
title: Buildpacks
description: "Understand how buildpacks work on Scalingo to detect apps, install dependencies, and define startup commands, then choose official, specific, or custom buildpacks."
nav: Introduction
