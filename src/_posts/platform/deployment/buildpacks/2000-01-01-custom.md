...
description: "Deploy unsupported technologies on Scalingo with a custom buildpack by setting BUILDPACK_URL, then verify detection and build behavior from deployment logs."
