...
description: "Combine multiple buildpacks on Scalingo with a .buildpacks file, order buildpacks correctly for your stack, and deploy apps that need mixed technologies."
