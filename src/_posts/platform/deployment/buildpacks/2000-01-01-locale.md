...
description: "Install additional language packs with the Locale buildpack on Scalingo, configure locales for your app, and verify locale availability in build output."
