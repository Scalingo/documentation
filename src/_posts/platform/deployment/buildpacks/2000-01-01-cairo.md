...
modified_at: 2022-12-30 00:00:00
...
{% warning %}
  This buildpack has been deprecated since scalingo-22 in favor of the [APT Buildpack]({% post_url platform/deployment/buildpacks/2000-01-01-apt %})
