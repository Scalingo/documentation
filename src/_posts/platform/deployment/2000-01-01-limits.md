...
description: "Review Scalingo deployment environment resources and platform limits, including CPU, RAM, swap, and build constraints, and request higher limits when needed."
nav: Limits
