...
When the platform processes a payment, it will select one payment method based on the priority order below. Only this chosen method will be used for all retries of the payment attempt.

The priority order is listed below:
