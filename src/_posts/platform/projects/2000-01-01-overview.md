...
[Private Networks][private-networks-page] allow you to group application containers in a dedicated and isolated network at the project level.

Resources within the same Private Network, and therefore within the same project, can communicate freely over the internal network. For larger applications, we recommend splitting resources into one project per environment so network boundaries align with data segregation between environments and their data sources.
