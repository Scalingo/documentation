...
Our platform is evolving to improve performance and resilience. As part of this change, our internal network is being rearchitected into multiple subnets, and each project is assigned to a dedicated subnet. As a result, resources from different projects may no longer be able to communicate over the regional internal network, as they can be placed on separate subnets. Cross-project communication remains possible through public URLs over the Internet.
