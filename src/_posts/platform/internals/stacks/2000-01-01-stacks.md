...
| ---- | ----------------- | --------------- | ---------- |
| [scalingo-20]({% post_url platform/internals/stacks/2000-01-01-scalingo-20-stack %}) | Ubuntu 20.04 | April 2023 | [scalingo/scalingo-20](https://hub.docker.com/r/scalingo/scalingo-20) |
