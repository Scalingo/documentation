---
title: FFmpeg
description: "Install FFmpeg and FFprobe on Scalingo applications using buildpack and package configuration so media processing commands run in app containers."
