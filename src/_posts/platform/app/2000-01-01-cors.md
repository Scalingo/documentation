...
description: "Understand CORS behavior on Scalingo and configure cross-origin request handling so browsers can safely access your application APIs from authorized origins."
nav: CORS
