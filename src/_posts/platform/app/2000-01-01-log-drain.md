...
layout: page
title: Log Drains
modified_at: 2022-11-15 00:00:00
tags: Papertrail Logmatic Graylog logs integration
index: 19
---
...
```
Parameters:
* `token`: Logtail's Bearer Token

This variable is available on
[Logtail documentation](https://betterstack.com/docs/logs/logging-start/).<br>
When connecting a new source in Logtail, please select the `HTTP` platform.
