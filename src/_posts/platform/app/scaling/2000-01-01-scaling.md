...
In the context of Platform as a Service such as Scalingo, ***scaling***
...
[***vertical*** scaling](#vertical-scaling) and
...
Scaling operations themselves are free, meaning there is no additional charge for changing the number or size of containers. However, scaling affects the number of allocated resources, which in turn impacts the total cost of your application.
