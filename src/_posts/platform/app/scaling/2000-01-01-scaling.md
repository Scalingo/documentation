...
{% warning %}
Changing the **container size** of an application that has the [**autoscaler**]({% post_url platform/app/scaling/2000-01-01-scalingo-autoscaler %})
turned on will **disable** the autoscaler for the corresponding process type.
{% endwarning %}
