...
instances of a resource (such as application containers) to distribute the
workload. This means deploying additional application instances that can each
process requests on their side or removing useless ones.
