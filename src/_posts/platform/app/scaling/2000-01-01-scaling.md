...
description: "Understand vertical and horizontal scaling on Scalingo, compare tradeoffs, and choose scaling strategies based on workload, resilience, and cost."
nav: Scaling
