...
description: "Rollback a Scalingo application to a previous version using Git or prior releases, with operational warnings and safe recovery workflow guidance."
nav: Rollback
