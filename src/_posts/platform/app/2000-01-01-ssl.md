...
| Provider                                                     | Key Information                                                     | Region         |
|--------------------------------------------------------------|---------------------------------------------------------------------|----------------|
| [**Actalis**](https://www.actalis.com/)                      | Suitable for european operators which require a CA based in Europe. | Europe (Italy) |
| [**Let's Encrypt**](https://letsencrypt.org/)                | Most popular, fully automated (ACME)                                | Global         |
| [**Sectigo**](https://www.sectigo.com/ssl-certificates-tls)  | No free tier, previously known as _Comodo_                          | Global         |
| [**SSL.com**](https://ssl.com/)                              | Free 90-day SSL/TLS certificates                                    | Global         |
| [**ZeroSSL**](https://zerossl.com/)                          | Free 90-day certificates and a fully-fledged REST API               | Global         |

#### CDN & Edge Providers

| Provider                                          | Key Information                          | Region              |
|---------------------------------------------------|------------------------------------------|---------------------|
| [**Gcore**](https://gcore.com/edge-network/cdn)   | European CDN with a free tier and SSL    | Europe (Luxembourg) |
| [**Cloudflare**](https://www.cloudflare.com/ssl/) | Free SSL termination and DDoS protection | Global              |

These are examples, there are other companies are providing this service.
