...
description: "Troubleshoot application crashes on Scalingo by diagnosing boot and runtime errors, using logs effectively, and setting notifications to detect failures quickly."
