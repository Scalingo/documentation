...
description: "Configure alerts on Scalingo application metrics, define trigger thresholds and durations, and monitor alert events to react quickly to performance or availability issues."
nav: Alerts
