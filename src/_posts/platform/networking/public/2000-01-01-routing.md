...
In modern web architecture, a reverse proxy designates a server that sits
...
{% note %}
At Scalingo, we've decided to entrust this task to [OpenResty], a powerful,
fast, and open-source web-platform extending nginx with LuaJIT.
{% endnote %}
...
available `web` containers of the application, ensuring basic load-balancing.
