...
description: "Create a Scalingo account with email/password or GitHub SSO, then access dashboard features to manage apps, databases, billing, invoices, and team access."
