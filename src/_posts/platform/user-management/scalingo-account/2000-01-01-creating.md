...
description: Create a Scalingo account using email/password or GitHub SSO, then sign in to the dashboard to manage apps, databases, billing, invoices, and team access.
