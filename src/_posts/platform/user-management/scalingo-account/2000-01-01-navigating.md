...
description: "Navigate Scalingo account dashboard settings to update profile and authentication, manage SSH keys and API tokens, connect SCM integrations, and handle HDS and referral options."
