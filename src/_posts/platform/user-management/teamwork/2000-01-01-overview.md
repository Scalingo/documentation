...
nav: Overview
description: Learn how Scalingo teamwork works: invite collaborators on an app, understand Owner, Collaborator, and Limited Collaborator roles, and navigate role-based access management guidance.
