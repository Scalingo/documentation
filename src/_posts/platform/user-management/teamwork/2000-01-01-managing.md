...
description: Manage app collaborators on Scalingo from Dashboard, CLI, or Terraform: list and export members, invite users, update roles, revoke access, and track collaborator events.
