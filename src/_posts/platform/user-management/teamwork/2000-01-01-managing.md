...
description: "Manage collaborators from dashboard, CLI, or Terraform: list and export members, invite users, update roles, revoke access, and review collaborator events."
