...
description: "Diagnose common Scalingo deployment failures, including unknown technology detection, monorepo project-dir issues, and buildpack selection conflicts, then apply environment-variable fixes."
