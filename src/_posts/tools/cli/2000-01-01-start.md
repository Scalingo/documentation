...
description: "Install the Scalingo CLI on Linux, macOS, Windows, or BSD, add it to PATH, and enable shell completion to manage apps, deployments, logs, and addons from terminal."
nav: Install
