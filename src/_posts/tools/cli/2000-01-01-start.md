...
description: "Install the Scalingo CLI on Linux, macOS, Windows, or BSD, configure PATH and shell completion, and start managing apps, logs, and add-ons from terminal."
nav: Install
