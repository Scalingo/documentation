---
title: Features
description: "Explore core Scalingo CLI commands to create apps, manage SSH keys and environment variables, deploy code, inspect logs, and operate platform resources efficiently."
