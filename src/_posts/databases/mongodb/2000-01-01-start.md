...
Scalingo provides different versions of MongoDB®:
* **4.0.3-1** (default)
* **4.0.27-1** (latest available)

Due to MongoDB® licensing changes, Scalingo supports MongoDB® up to versions **3.6.x** and **4.0.x**.
