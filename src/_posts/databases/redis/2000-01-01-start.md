...
| Redis Version | Full Version    |
|--------------:|----------------:|
| **`7.2`**     | up to `7.2.13-1` |
| `6.2`         | up to `6.2.20-1` |

The latest version of Redis® OSS available is **`7.2.13-1`**.
The default version is Redis® OSS **`7.2.13-1`** when attaching a Scalingo for Caching addon to your
application.

{% note %}
If you need to provision a Scalingo for Caching addon with a specific version,
