...
Scalingo for MySQL® is compatible with all modes available and supported by
MySQL® 8.0 LTS. The complete list and their descriptions can be found
[in the official MySQL documentation](https://dev.mysql.com/doc/refman/8.0/en/sql-mode.html).

The default SQL mode in MySQL® 8.0 includes: `ONLY_FULL_GROUP_BY`,
