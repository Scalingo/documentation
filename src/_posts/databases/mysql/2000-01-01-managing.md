...
3. In **General**, select **Change plan** (settings/general)
...
1. From your web browser, [open your database dashboard]({% post_url databases/mysql/2000-01-01-getting-started %}#accessing-the-scalingo-for-mysql-dashboard)
2. Click on the **Settings** tab
3. In **General**, if an upgrade is available, the text in the block explains what will be
   done.
4. To launch the upgrade, click the **Upgrade to &#8230** button
...
{% note %}
You can choose a user password only from the command line.
{% endnote %}
...
4. Fill the **Add a user** form:
   - Fill a username
5. (optional) If you want to allow this user to have writings abilities, make
   sure to check the **Write** checkbox
...
5. Click the **"&#8230"** button next to the user and select **Reset password**
6. Confirm the deletion by typing the name of the user in the popup window
7. Validate by clicking the **Confirm** button

{% note %}
A secure password will be generated automatically. You will be able to view and copy it only once.
It will appear in a popup window after the password reset.
{% endnote %}
...
3. In the **Settings** submenu, select **Users**
4. Locate the user you want to remove
5. Click the **"&#8230"** button next to the user and select **Delete user**
6. Confirm the deletion by typing the name of the user in the popup window
7. Validate by clicking the **Confirm** button
...
5. Click the **"&#8230"** button next to the database and select **Drop**
6. Confirm the deletion by typing the name of the database in the popup window
7. Validate by clicking the **Confirm** button
...
4. Click on **Manage SQL modes** to select the mode(s) you are interested in
5. Click the **Update configuration** button to confirm
6. The changes are done at runtime, which means they immediately apply to new
   queries
