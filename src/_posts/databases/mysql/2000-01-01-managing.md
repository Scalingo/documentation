...
5. Click the **"&#8230;"** button next to the user and select **Reset password** from the popup menu
...
5. Click the **"&#8230;"** button next to the database and select **Drop** from the popup menu
6. In the popup window, confirm the deletion by typing the name of the database
7. Validate by clicking the **Confirm** button
