...
5. Click the **"&#8230;"** button next to the user and select **Reset password**
...
3. In the **Settings** submenu, select **Users**
4. Locate the user you want to remove
5. Click the **"&#8230;"** button next to the user and select **Delete user**
6. Confirm the deletion by typing the name of the user in the popup window
7. Validate by clicking the **Confirm** button
...
5. Click the **"&#8230;"** button next to the database and select **Drop**
