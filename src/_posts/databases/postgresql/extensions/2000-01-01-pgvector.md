---
title: pgvector
description: "Use pgvector on Scalingo PostgreSQL to store vectors, build similarity indexes, and run nearest-neighbor search for semantic search and ML workloads."
nav: pgvector
