---
title: PostGIS
description: "Enable and use PostGIS on Scalingo PostgreSQL to store, index, and query geospatial data, with platform-specific prerequisites and operational constraints."
nav: PostGIS
