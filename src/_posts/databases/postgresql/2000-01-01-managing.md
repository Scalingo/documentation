...
2. Click on the **Settings** tab. Locate the **Database Upgrade** block
...
{% note %}
Protected users password cannot be deleted
{% endnote %}
...
### Show the enabled extensions

#### Using the Database Dashboard

1. From your web browser, [open your database dashboard]({% post_url databases/postgresql/2000-01-01-getting-started %}#accessing-the-scalingo-for-postgresql-dashboard)
2. Click on the **Settings** tab
3. In the **Settings** submenu, select **Condiguration**
4. Locate the **PostgreSQL Extensions**
5. The list of enabled extensions will appear in small pills
