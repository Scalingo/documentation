...
description: "Explore Scalingo for PostgreSQL: service scope, supported versions and lifecycle, default provisioning version, pricing model, and links to high availability, features, limits, and extensions."
nav: Overview
...
|--------------------|-------------------|------------------------|
| `17`               | up to `17.9.0-2`  | Support until Nov 2029 |
| **`16`**           | up to `16.13.0-2` | Support until Nov 2028 |
| `15`               | up to `15.17.0-2` | Support until Nov 2027 |
| `14`               | up to `14.22.0-1` | Support until Nov 2026 |
