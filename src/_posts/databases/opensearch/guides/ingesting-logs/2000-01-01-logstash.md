...
FIXME: explanations and schema here.
...
When using this feature, the application name (`appname`) and the container
name (`hostname`) are passed as query parameters and the log entry itself is in
the request body.
