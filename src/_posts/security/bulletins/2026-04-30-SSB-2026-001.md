...
To our knowledge, the attacker remains constrained to the container environment allocated to them, and there is no known container escape path associated with the current exploit.
