...
| `ext-igbinary`  | Optional | Optional | Optional |          |
...
| `ext-igbinary`  | `3.2.16` | `3.2.16` | `3.2.16` |          |
| `ext-imagick`   | `3.8.1`  | `3.8.1`  | `3.8.1`  | `3.8.1`  |
...
| New Relic | `11.5.0.18` | `11.5.0.18` | `11.5.0.18` | `12.5.0.30` |
