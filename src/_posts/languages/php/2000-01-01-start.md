...
description: "Deploy PHP apps on Scalingo: understand detection rules, Nginx and PHP-FPM stack defaults, select supported PHP versions with composer constraints, and review runtime configuration."
nav: Introduction
...
| ----------- | ------------------- | ---------------- | ---------------- |
| **`8.5`**   | unsupported         | up to `8.5.4`    | up to `8.5.4`    |
| **`8.4`**   | up to `8.4.6`       | up to `8.4.19`   | up to `8.4.19`   |
