...
nav: Introduction
modified_at: 2025-11-24 00:00:00
tags: php
index: 1
---
...
| ----------- | ------------------- | ---------------- | ---------------- |
| **`8.5`**   | unsupported         | up to `8.5.0`    | up to `8.5.0`    |
| **`8.4`**   | up to `8.4.6`       | up to `8.4.15`   | up to `8.4.15`   |
| **`8.3`**   | up to `8.3.20`      | up to `8.3.28`   | up to `8.3.28`   |
| **`8.2`**   | up to `8.2.28`      | up to `8.2.29`   | up to `8.2.29`   |
| **`8.1`**   | up to `8.1.32`      | up to `8.1.33`   | up to `8.1.33`   |
