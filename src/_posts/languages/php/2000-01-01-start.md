...
nav: Introduction
modified_at: 2023-08-03 16:00:00
tags: php
index: 1
---
...
|   **`8.0`** | up to `8.0.29` |    unsupported |
|   **`8.1`** | up to `8.1.21` | up to `8.1.21` |
|   **`8.2`** |  up to `8.2.8` |  up to `8.2.8` |
...
{% note %}
The Datadog agent must be installed first ([see the documentation]({% post_url platform/app/datadog %})).
{% endnote %}
