...
description: "Deploy PHP apps on Scalingo: check detection rules, review Nginx and PHP-FPM defaults, select supported PHP versions with composer constraints, and tune runtime configuration."
nav: Introduction
