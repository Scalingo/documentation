...
nav: Introduction
modified_at: 2026-09-25 00:00:00
tags: php
index: 1
---
...
| ----------: | ----------------: | ----------------: | ----------------: |
| **`8.5`**   | up to `8.5.11`    | up to `8.5.11`    | up to `8.5.11`    |
| **`8.4`**   | up to `8.4.26`    | up to `8.4.26`    | up to `8.4.26`    |
| **`8.3`**   | up to `8.3.35`    | up to `8.3.35`    | up to `8.3.35`    |
| **`8.2`**   | up to `8.2.34`    | up to `8.2.34`    | up to `8.2.34`    |
