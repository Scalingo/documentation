...
nav: Introduction
modified_at: 2024-12-29 00:00:00
...
| ------ | ------- | --- | ---- |
| >= 3.0 | 20.x | 10.x | 1.x |
| 2.3 - 2.16 | 14.x | 6.x | 1.x |

{% note %}
Meteor 1.x and 2.x are no longer supported. We strongly recommend upgrading your application to Meteor 3+.
{% endnote %}
...
application, don't worry. It is **done by default by the platform**. [The flag
