---
title: Gradle
description: "Configure and deploy Java apps with Gradle on Scalingo: buildpack detection, wrapper and Java compatibility, custom GRADLE_TASK or stage tasks, default web process, and Grails 3 setup troubleshooting."
