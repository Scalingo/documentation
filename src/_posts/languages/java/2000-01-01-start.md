...
nav: Introduction
modified_at: 2025-09-23 00:00:00
tags: java
index: 1
---
...
| --------------- | ------------------: | ------------------: | ------------------: |
| **`25 (LTS)`**  | unsupported         | up to `25.0.0`      | up to `25.0.0`      |
| **`24`**        | up to `24.0.1`      | up to `24.0.2`      | up to `24.0.2`      |
| **`21 (LTS)`**  | up to `21.0.7`      | up to `21.0.8`      | up to `21.0.8`      |
| **`17 (LTS)`**  | up to `17.0.15`     | up to `17.0.16`     | up to `17.0.16`     |
| **`11 (LTS)`**  | up to `11.0.27`     | up to `11.0.28`     | up to `11.0.28`     |
| **`8 (LTS)`**   | up to `1.8.0_452`   | up to `1.8.0_462`   | up to `1.8.0_462`   |
