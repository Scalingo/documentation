...
| --------------- | ------------------: | ------------------: | ------------------: |
| **`25 (LTS)`**  | unsupported         | up to `25.0.1`      | up to `25.0.1`      |
| **`21 (LTS)`**  | up to `21.0.7`      | up to `21.0.9`      | up to `21.0.9`      |
| **`17 (LTS)`**  | up to `17.0.15`     | up to `17.0.17`     | up to `17.0.17`     |
| **`11 (LTS)`**  | up to `11.0.27`     | up to `11.0.29`     | up to `11.0.29`     |
| **`8 (LTS)`**   | up to `1.8.0_452`   | up to `1.8.0_472`   | up to `1.8.0_472`   |
