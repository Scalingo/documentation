...
title: Elixir
nav: Introduction
modified_at: 2022-11-25 00:00:00
tags: elixir phoenix
---
...
{% note %}
Currently, Scalingo does not support Elixir on the scalingo-20 stack. You can find a [buildpack and a tutorial for Phoenix 1.6 thanks to a community member](https://b310.de/blog/scalingo-phoenix-1-6.html).
{% endnote %}
