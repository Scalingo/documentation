...
platform/deployment/buildpacks/2000-01-01-apt %}). Some functionalities are available only by adding optional package dependencies, see [Vips documentation for more information](https://github.com/libvips/libvips#optional-dependencies).
