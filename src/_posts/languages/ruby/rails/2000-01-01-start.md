...
{% note %}
Note for SQLish databases at the boot of the database, Scalingo creates a database.
So if you need a specific configuration of charset or collation for example, you first need to configure
it before running first database migration.
{% endnote %}
