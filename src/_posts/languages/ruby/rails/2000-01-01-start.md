...
Some functionalities, for example HEIF support, will be available only by adding optional package dependencies, see [Vips documentation for more informations](https://github.com/libvips/libvips#optional-dependencies).
