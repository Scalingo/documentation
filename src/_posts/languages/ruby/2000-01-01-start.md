...
| ------------ | ------------------- | --------------- | --------------- |
| **`4.0`**    | Unavailable         | up to `4.0.2`   | up to `4.0.2`   |
| **`3.4`**    | up to `3.4.3`       | up to `3.4.9`   | up to `3.4.9`   |
| **`3.3`**    | up to `3.3.8`       | up to `3.3.11`  | up to `3.3.11`  |
| **`3.2`**    | up to `3.2.8`       | up to `3.2.11`  | up to `3.2.11`  |
