---
title: Node.js
description: "Deploy Node.js apps on Scalingo: detect package manifests, install dependencies with npm or Yarn, configure private registry access, and tune build and runtime behavior."
nav: Introduction
...
| `v24` (LTS)     | up to `24.14.1` | up to `24.14.1` |
| `v22` (LTS)     | up to `22.22.2` | up to `22.22.2` |
| `v20` (LTS)     | up to `20.20.2` | up to `20.20.2` |

### Select a Version

The default Node.js version on all stacks is the latest `v22` version. If you
...
buildpack for example - then you'll need to use Yarn 2+ and set `YARN2_SKIP_PRUNING=true`.

| Package Manager | Environment Variable    | Install Dev Deps | Prune |
| --------------- | ----------------------- | :--------------: | :---: |
| npm             | none                    | Yes              | Yes   |
