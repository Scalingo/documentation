---
title: Node.js
description: "Deploy Node.js apps on Scalingo: detect package manifests, install dependencies with npm or Yarn, configure private registry access, and tune build/runtime behavior."
nav: Introduction
