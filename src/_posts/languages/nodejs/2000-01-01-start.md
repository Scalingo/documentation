...
| Package manager | Version | Environment variable    | CLI                                                         |
|-----------------|---------|-------------------------|-------------------------------------------------------------|
| npm             | Any     | `NPM_CONFIG_PRODUCTION` | `scalingo --app my-app env-set NPM_CONFIG_PRODUCTION=false` |
| yarn            | v1      | `YARN_PRODUCTION`       | `scalingo --app my-app env-set YARN_PRODUCTION=false`       |
| yarn            | v2+     | `YARN2_SKIP_PRUNING`    | `scalingo --app my-app env-set YARN2_SKIP_PRUNING=true`     |
...
If no version is defined, Scalingo installs the latest version of v20.
