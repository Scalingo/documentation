...
| Go Version | `scalingo-22` (EOL[^EOL])   | `scalingo-24`   |
| ---------- | --------------- | --------------- |
...
[^EOL]: EOL stands for End-of-Life. Until its end-of-support date, the stack remains supported. After that date, customers must migrate to a newer supported stack.
