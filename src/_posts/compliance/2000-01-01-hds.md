...
The certificate number is 38436, it was issued by [LNE](https://www.lne.fr/en) (now renamed **BYCYB**) and it is valid until September 11, 2028.
...
Moreover, Scalingo must be able to provide this list without delay, on demand of the competent authorities, particularily if the HDS certification is to be suspended or removed (HDS certification referential v2.0, requirement EXI 11).
...
Le numéro de certificat est 38436, il a été délivré par [LNE](https://www.lne.fr/) (désormais dénommé **BYCYB**) et il est valable jusqu'au 11 septembre 2028.
...
En outre, Scalingo doit être en capacité de transmettre sans délai cette liste à l’autorité compétente sur demande, notamment en cas de suspension ou de retrait de la certification HDS (Référentiel de certification HDS v2.0, exigence EXI 11).
