...
We have added a new feature to the [Collaborators]({% post_url /platform/user-management/teamworking/2000-01-01-overview %}) page, allowing you to see whether your collaborators have enabled **Two-Factor Authentication (2FA)**.  
...
[See related documentation]({% post_url /platform/user-management/teamworking/2000-01-01-overview %})
