...
The [scalingo-22]({% post_url platform/internals/stacks/2000-01-01-scalingo-22-stack %}) stack, based on the Ubuntu 22.04 LTS operating system, will reach end-of-life on May 1, 2027.
...
- **May 1, 2027: End of support**. Ubuntu 22.04 LTS and scalingo-22 officially reach end-of-life and no longer receive updates.
...
To ensure the security, performance, and reliability of your applications, we encourage you to migrate to scalingo-24 before May 1, 2027.
