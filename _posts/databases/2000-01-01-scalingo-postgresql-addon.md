...
If you wish to manually backup your database, please follow [How to dump and restore my PostgreSQL database on Scalingo]({% post_url 2015-10-01-dump-restore-postgresql %}) guide.
