...
Once the addon is provisioned, 1 environment variable is added to your app: `SCALINGO_POSTGRESQL_URL`. To find out how to use it in your code please refer to [Application environment]({% post_url /app/2014-09-15-environment %}).
