...
phpMyAdmin instances are available. Their addresses depend on the region your database is hosted on:
...
Adminer instances are available. Their addresses depend on the region your database is hosted on:
