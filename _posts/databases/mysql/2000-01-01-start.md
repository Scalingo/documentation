...
Some providers like Google DataStudio will require a client certificate when TLS is enabled. In this case, contact us via the in app chat or via mail at support@scalingo.com.
