...
- `agora-fr1`: [https://phpmyadmin.scalingo.io](https://phpmyadmin.scalingo.io).
- `osc-fr1`: [https://phpmyadmin.osc-fr1.scalingo.io](https://phpmyadmin.osc-fr1.scalingo.io).
- `osc-secnum-fr1`: [https://phpmyadmin.osc-secnum-fr1.scalingo.io](https://phpmyadmin.osc-secnum-fr1.scalingo.io).
...
Adminer instances are available in each region. Choose the one hosted in the region where your database is hosted.

- `agora-fr1`: [https://adminer.scalingo.io](https://adminer.scalingo.io).
- `osc-fr1`: [https://adminer.osc-fr1.scalingo.io](https://adminer.osc-fr1.scalingo.io).
- `osc-secnum-fr1`: [https://adminer.osc-secnum-fr1.scalingo.io](https://adminer.osc-secnum-fr1.scalingo.io).
