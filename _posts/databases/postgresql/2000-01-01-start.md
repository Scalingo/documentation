...
See the section "Addons" on our [API Reference](https://developers.scalingo.com/addons).
...
## Access Scalingo PostgreSQL Databases

If you need to access your database from other places than your app please
follow the [Access Scalingo PostgreSQL Databases]({% post_url
databases/postgresql/2000-01-01-access %}) guide.
