...
- multiple Elasticsearch nodes in a private network: the amount of memory per node depends on the
  plan,
...
restarted with new database environment. When this operation finishes, your application will be
restarted.
