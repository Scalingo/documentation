...
Since we don't want to have unecnrypted databases openned on the internet, the db-tunnel provides an encrypted way of accessing your database. However it does not provide any additionnal security layer. We will only verify that your public ley is registredd on our platform. The db-tunnel is just an encrypted bridge between your laptop and our infrastructure.
