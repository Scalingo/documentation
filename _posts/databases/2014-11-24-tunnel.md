...
The db-tunnel does not provide any additionnal security layer. We will only verify that your Public Key is registerd on our platform. The db-tunnel is just an encrypted bridge between your laptop and our infrastructure.
