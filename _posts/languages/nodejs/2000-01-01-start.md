...
title: Node.js
nav: Introduction
modified_at: 2020-03-13 00:00:00
tags: nodejs
index: 1
---
...
To authenticate to the SCM service, you need to use our [SSH Private Key Buildpack]({% post_url platform/deployment/buildpacks/2000-01-01-ssh-key %}), this buildpack will let you setup a private SSH key securely in the build environment.
