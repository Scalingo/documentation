...
title: Node.js
nav: Introduction
modified_at: 2021-02-23 00:00:00
tags: nodejs
index: 1
---
...
are using npm version 6 or higher, Scalingo will use `npm ci` to install your
dependencies. Otherwise Scalingo will fallback to `npm install`.
