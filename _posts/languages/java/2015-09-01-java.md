...
* Spring Boot: You can find custom information about this framework at the [following page]({% post_url 2015-08-26-spring-boot %})
...
to your project in order to execute it, [follow the guide]({% post_url 2015-03-25-war %})
