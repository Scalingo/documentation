...
* Phalcon Framework: [`phalcon`](https://phalconphp.com/en/) (incompatible with
    PHP 7.4 and above)
...
{% warning %}
If the `WEB_CONCURRENCY` value is not well defined, you will see at some point
the following error message in your application logs:
...
empties this requests queue and makes your application back up.
{% endwarning %}
