...
* Math functions: [`bcmath`](https://www.php.net/manual/fr/book.bc.php)
* Images manipulation: [`gd`](https://www.php.net/manual/fr/book.image.php)
...
* FTP Client: [`ftp`](https://www.php.net/manual/fr/book.ftp.php)
* IMAP: [`imap`](https://www.php.net/manual/en/book.imap.php)
* Tidy: [`tidy`](https://www.php.net/manual/en/book.tidy.php)
* Calendar: [`calendar`](https://www.php.net/manual/en/book.calendar.php)
* Data Structures: [`ds`](https://www.php.net/manual/fr/book.ds.php)
...
* [Phalcon](https://sample-php-phalcon.scalingo.io)
