...
a precise version it should be mentionned in your `composer.json` file.
...
{% note %}
  You can precise a version directly or use any kind of [semver range](https://semver.scalingo.io/#ranges):
  **~7.0** to get the latest version of the 7.0 version branch for instance.
{% endnote %}
