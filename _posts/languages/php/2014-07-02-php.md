...
* [Symfony 2]({% post_url 2000-01-01-php-symfony2-deployment %})
* Zend Framework 2
* Magento
* Slim
* Laravel
...
can [configure HTTP basic auth]({% post_url 2000-01-01-php-basic-auth %}) for you application.

### Buildpack tweaks - custom configuration

> [_What is a buildpack_]({% post_url 2015-01-04-buildpacks %})
