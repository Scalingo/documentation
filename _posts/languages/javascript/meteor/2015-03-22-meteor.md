...
is not recommanded. Using this method prevents you from easily creating multiple
environment of your apps for instance.

We advise you to use the environment variable `METEOR_SETTINGS`, the variable
is automatically read by Meteor and it stays our of your code repository.
