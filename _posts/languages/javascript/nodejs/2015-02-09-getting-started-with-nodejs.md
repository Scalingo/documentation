...
The 'Procfile' (with a capital 'P') is the file defining how your application is supposed to start ([more info about Procfile]({% post_url configuration/2000-01-01-procfile %})), here is the content you have to write in the 'Procfile' file for this project:
