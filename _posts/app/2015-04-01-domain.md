...
post_url app/2016-12-23-letsencrypt %}) is automatically generated for your
application.
...
<blockquote class="bg-info">
  Note that we do not support yet Let's Encrypt wildcard certificates. If you add such a custom domain, we
  will not be able to create the Let's Encrypt certificate.
</blockquote>
