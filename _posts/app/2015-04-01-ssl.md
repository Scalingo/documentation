...
However, we do not support yet Let's Encrypt certificate for wildcard domain.
Hence, we will not be able to provide automatic HTTPS certificate in that case.
