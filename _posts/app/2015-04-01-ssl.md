...
Native [Let's Encrypt](https://letsencrypt.org/) support is planned for late 2016. For the time being, you must look at Let's Encrypt support in the language or framework you're using, or, use a traditionnal SSL support (i.e. StartSSL has a free 1 year SSL certificate). 
