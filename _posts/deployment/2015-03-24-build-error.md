...
You application image is built using a buildpack ([List of buildpacks]({% post_url 2015-01-04-buildpacks %})).
...
* Define a [.slugignore file]({% post_url 2015-03-24-slugignore %}) to exclude files from the
  image.
