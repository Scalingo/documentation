...
[HTTPS support]({% post_url 2015-04-01-ssl %}) is included by default. It is managed by application. When a custom domain name is added, our [Let's Encrypt integration]({% 2016-12-23-letsencrypt.md %}) will generate a valid certificate for this domain name to get valid HTTPS automatically.
