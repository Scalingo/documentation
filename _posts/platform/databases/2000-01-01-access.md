...
platform/databases/2000-01-01-tunnel %}) or by forcing TLS connection to your database.

## Direct encrypted access to the database

It is possible to make your database reachable from anywhere on internet. You
first need to force TLS connections to your databases from your database dashboard. Then head to
