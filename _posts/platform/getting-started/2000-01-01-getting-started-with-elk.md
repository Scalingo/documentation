...
And you're all set, just `git push scalingo master` and your Logstash instance
...
To deploy Kibana on Scalingo, you are invited to use our one-click button just
over here: [![Deploy on
...
just contact the Scalingo team via the in-chat support or via email at
