...
project is analyzed and the different way to start your project are
...
If you're looking to execute [scheduled tasks]({% post_url platform/app/2000-01-01-run-scheduled-tasks %}),
you'd better read [this page]({% post_url platform/app/2000-01-01-run-scheduled-tasks %}).

## Networking

The feature requires your workstation to allow connections to the **TCP port 5000**. Otherwise you will experience timeouts during the connection attempts.
