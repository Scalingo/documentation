...
By default, the one-off container does not contain the CLI client to connect to your database.
However, you can use the script `dbclient-fetcher` to download and install it. Using this script is
as simple as:
