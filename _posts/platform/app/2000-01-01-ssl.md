...
The platform is limited by official Let's Encrypt quotas: https://letsencrypt.org/docs/rate-limits/.
...
* Action required: to achieve the creation of your Let's Encrypt certificates for a wildcard domain,
  ...
  See [wildcard domain documentation]({% post_url platform/app/2000-01-01-domain %}) for more information.
