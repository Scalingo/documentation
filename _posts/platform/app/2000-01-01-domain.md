...
If your domain is managed by Gandiv5, you can add the following variables:
    ...
    GANDIV5_API_KEY=<your_gandiv5_api_key>
...
If your domain is managed by Gandiv5, you can add the following variables:
    ...
    DNS_PROVIDER=gandi
    GANDIV5_API_KEY=<your_gandi_api_key>
...
For more information about OVH, see their [documenation](https://api.ovh.com/g934.first_step_with_api).
