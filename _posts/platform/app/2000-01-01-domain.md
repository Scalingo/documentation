...
Encrypt certificate. But to complete the procedure, you need to create a TXT
...
know that you are the owner of the wildcard domain. Here is an example of the
DNS configuration for the domain `*.example.com`:
