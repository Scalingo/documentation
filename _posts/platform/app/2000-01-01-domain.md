...
* Create an Application: go on Azure Active Direcoty > App Registrations > New application registration. Fill the form (the Sign-on URL is completely arbitrary).
...
<!-- * Add permissions: On the Settings page, go on Required permissions > Windows Active Azure Direcoty > Select `Read and write domains`. Save and Grant permissions. -->
