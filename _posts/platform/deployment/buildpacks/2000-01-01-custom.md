...
Hub__.  Its name is
[scalingo/scalingo-18](https://hub.docker.com/repository/docker/scalingo/scalingo-18). The base
...
docker run --interactive --tty -v /path/to/custom-buildpack:/buildpack scalingo/scalingo-18:latest bash
```
