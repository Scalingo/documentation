...
[HTTPS support]({% post_url platform/app/2000-01-01-ssl %}) is included by default. It is managed by application. When a custom domain name is added, our [Let's Encrypt integration]({% post_url platform/app/2000-01-01-letsencrypt %}) will generate a valid certificate for this domain name to get valid HTTPS automatically.
